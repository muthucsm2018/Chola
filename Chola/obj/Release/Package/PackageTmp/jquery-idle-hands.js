        ...
        let createDialog = function () {
            let dialogContainer =
             ...
             //                      '</div>';
                             ...
                             //                 '<p>You will be logged out in ' + '<span id="jquery-idle-hands-time-remaining"></span>' + '. Any unsaved transactions will be lost. Do you wish to remain logged in?</p>' +
                             //             '</div>' +

                             //             '<div class="modal-footer">' +
                             //                 '<button id="jquery-idle-hands-logout-button" type="button" class="btn btn-default btn-lg">Log out</button>' +
                             //                 '<button id="jquery-idle-hands-stay-logged-in-button" type="button" class="btn btn-lg btn-primary" data-dismiss="modal">KEEP ME LOGGED IN</button>' +
                             //             '</div>' +
                             //        '</div>' +
                             //   '</div>' +
                             //'</div>';
                                        ...
                                        '<div class="NgModal">' +
                                          '<div class="NgModal-content">' +
                                            ...
                                            '<div class="NgModal-body">' +
                                              '<p>You will be logged out in ' + '<span id="jquery-idle-hands-time-remaining"></span>' + '. Any unsaved transaction will be lost. Do you wish to remain logged in?</p>' +
                                            '</div>' +

                                            '<div class="NgModal-footer">' +
		                                        '<div class="button-float">' +
		                                         '<button id="jquery-idle-hands-logout-button" type="button" class="button-logout">Log out</button>' +
		                                         '<button id="jquery-idle-hands-stay-logged-in-button" type="button" class="button">KEEP ME LOGGED IN</button>' +
		                                         '</div>' +
                                            '</div>' +
            ...
            //// Get the NgModal
            //var NgModal = document.getElementById("myModal");

            //// Get the <span> element that closes the NgModal
            //var span = document.getElementsByClassName("close")[0];

            //// When the user clicks on <span> (x), close the NgModal
